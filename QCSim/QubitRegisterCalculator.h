...
namespace QC {
	...
	public:
		...
		inline void ApplyOneQubitGate(const GateClass& gate, const VectorClass& registerStorage, VectorClass& resultsStorage, const MatrixClass& gateMatrix, const unsigned int qubitBit, const unsigned int NrBasisStates)
		{
		...
		inline void ApplyOneQubitGateOmp(const GateClass& gate, const VectorClass& registerStorage, VectorClass& resultsStorage, const MatrixClass& gateMatrix, const unsigned int qubitBit, const unsigned int NrBasisStates)
		{
			const unsigned int notQubitBit = ~qubitBit;
...
#pragma omp parallel for schedule(static, 8192)
		...
		inline void ApplyTwoQubitsGate(const GateClass& gate, const VectorClass& registerStorage, VectorClass& resultsStorage, const MatrixClass& gateMatrix, const unsigned int qubitBit, const unsigned int ctrlQubitBit, const unsigned int NrBasisStates)
		{
			const unsigned int notQubitBit = ~qubitBit;
		...
		inline void ApplyTwoQubitsGateOmp(const GateClass& gate, const VectorClass& registerStorage, VectorClass& resultsStorage, const MatrixClass& gateMatrix, const unsigned int qubitBit, const unsigned int ctrlQubitBit, const unsigned int NrBasisStates)
		{
			const unsigned int notQubitBit = ~qubitBit;
			const unsigned int notCtrlQubitBit = ~ctrlQubitBit;
			const unsigned int orqubits = qubitBit | ctrlQubitBit;
...
#pragma omp parallel for schedule(static, 4096)
		...
		inline void ApplyThreeQubitsGate(const GateClass& gate, const VectorClass& registerStorage, VectorClass& resultsStorage, const MatrixClass& gateMatrix, const unsigned int qubitBit, const unsigned int qubitBit2, const unsigned int ctrlQubitBit, const unsigned int NrBasisStates)
		{
			const unsigned int notQubitBit = ~qubitBit;
			const unsigned int notCtrlQubitBit = ~ctrlQubitBit;
		...
		inline void ApplyThreeQubitsGateOmp(const GateClass& gate, const VectorClass& registerStorage, VectorClass& resultsStorage, const MatrixClass& gateMatrix, const unsigned int qubitBit, const unsigned int qubitBit2, const unsigned int ctrlQubitBit, const unsigned int NrBasisStates)
		{
			const unsigned int notQubitBit = ~qubitBit;
			const unsigned int notCtrlQubitBit = ~ctrlQubitBit;
			const unsigned int notQubitBit2 = ~qubitBit2;
