...
static bool TraceRestoreAndHermitizeTestMPO()
{
	...
	drifted.setToMixtureOfBasisStates(std::vector<std::pair<QC::TensorNetworks::MPOSimulatorInterface::IndexType, double>>{
	...
	restored.setToMixtureOfBasisStates(std::vector<std::pair<QC::TensorNetworks::MPOSimulatorInterface::IndexType, double>>{
		{0, 0.1}, {1, 0.2}, {2, 0.3}, {3, 0.4} });
	...
	restoredGate.setToMixtureOfBasisStates(std::vector<std::pair<QC::TensorNetworks::MPOSimulatorInterface::IndexType, double>>{
		{0, 0.1}, {1, 0.2}, {2, 0.3}, {3, 0.4} });
...
static bool DiagnosticsTestMPO()
{
	...
	mixed.setToMixtureOfBasisStates(std::vector<std::pair<QC::TensorNetworks::MPOSimulatorInterface::IndexType, double>>{
		{0, 0.5}, {1, 0.5} });
